      ...
      <div className="subheader_container">
        <div className="title-1">
          <p data-aos="fade-down">
            WEL<span className="word-white">COME TO</span>
            <br />
            <motion.span
              data-aos="fade-up"
              className="word-yellow"
              variants={infinityAnimation}
              animate="visible"
            >
              MY WEB
            </motion.span>
        ...
        <div data-aos="fade-right" class="title-2">
          <p>
            BUILD WITH <span className="word-love">LOVE</span>,<br />
            NO I MEAN BUILD WITH <br />
            <motion.span
              variants={infinityAnimation}
              animate="visible"
